    ...
    en: {
      translation: {
        ...
        motivation: {
          ...
          newWayDesc:
            "With the Score System, Learning is full of entertainment and fun. For the first time, your interaction with different school activities will give you rewards, discounts, and exclusive offers for our members in many famous places and shops.",
          whyTitle: "Why?",
          whyDesc:
            "When you interact with different learning objects and activates, you will earn points and start competing with your colleagues based on the score of each one, exactly as if you are competing with them in a game.",
          ...
          summaryDesc:
            "Every member starts his/her journey with a green membership card. In each semester, you will start earning points from the first day. Your final score at the end of the semester will determine the type of card you deserve to use throughout the next semester as recognition for your efforts.",
          range1: "0 and 250",
          range2: "251 to 400",
          range3: "401 or more",
          cardText: " Card.",
          ...
          summaryPoint2:
            "in your school, you will be eligible for the Learnova",
          scoreFactors:
        ...
        table: {
          ...
          messageComment:
            "Your score is based on the number of recipients who read your message. More reads = more points. If no one reads it, you get no points.",
          courseMaterials: "Course Materials",
        ...
        materialDetails: {
          ...
          errors: {
            ...
            noMaterial: {
              ...
              message:
                "It looks like there are no details available for this material.",
              backButton: "Go Back",
            },
          },
          mediaTypes: {
        ...
        exam: {
          ...
          alerts: {
            ...
            noActiveSession: {
              ...
              message:
                "Either the exam is already submitted or the session has expired.",
              confirmButton: "OK",
            },
            submitted: {
            ...
            alreadySubmitted: {
              ...
              message:
                "Your exam was already submitted. Returning to exam list.",
              confirmButton: "OK",
            },
            error: {
              title: "Error!",
        ...
        exams: {
          alerts: {
            ...
            activeSession: {
              title: "Warning!",
              message:
                "You already have an active session. Resuming your previous exam.",
        ...
        teacherHeader: {
          add: "Add Teacher",
          searchPlaceholder:
            "Search for a teacher by name , email , gender or subject ",
          searchPlaceholder1:
            "Search for a class teacher by class, subject, teacher, or academic year",
        },
        parentHeader: {
          add: "Add Parent",
        ...
        adminTable: {
          ...
          noAdminsFound: {
            ...
            description:
              "It seems like there are no admins in the database at the moment.",
          },
        },
        parentTable: {
          ...
          noParentsFound: {
            ...
            description:
              "It seems like there are no parentS in the database at the moment.",
          },
        ...
        managerTable: {
          ...
          noManagersFound: {
            ...
            description:
              "It seems like there are no managers in the database at the moment.",
          },
        },
        studentTable: {
          ...
          noStudentsFound: {
            ...
            description:
              "It seems like there are no students in the database at the moment.",
          },
        },
        teacherTable: {
          ...
          noTeachersFound: {
            ...
            description:
              "It seems like there are no teachers in the database at the moment.",
            title1: "No Class Teacher Found",
            description1:
              "It seems like there are no class teachers in the database at the moment.",
          },
        },
        formLabels: {
          fullName: "Full Name",
        ...
        scheduleAdmin: {
          ...
          table: {
            ...
            noData: {
              ...
              message:
                "It seems like there are no schedules in the database at the moment.",
            },
        ...
        parent: {
          ...
          assignments: {
            ...
            "errors": {
              "missingClassId": "Missing Student Information",
              "selectKidInstruction": "Please select a student first from your kids list",
              "selectKidButton": "Select Student"
            },
            "main": {
              "title": "Assignments",
              ...
              "of": "of",
              "noAssignments": {
                "all": "No assignments available",
                "completed": "No completed assignments",
                "missed": "No missed assignments",
        ...
        gradesSemesterForChild: {
          title: "Semester Grades for ",
          back: "Back",
          subjectName: "Subject Name",
          midtermGrade: "Midterm Degree",
          maxMidterm: "Max Midterm Degree	",
          finalGrade: "Final Degree	",
          maxFinal: "Max Final Degree	",
          subjectScore: "Subject Score",
          maxSubjectScore: "Max Subject Score",
          percentage: "Percentage",
        ...
        chooseRole: {
          title: "Experience digital education like never before",
        },
        ...
        chatbot: {
          ...
          inputTooltip: "Please enter a message",
          buttonTooltip: "Input is empty",
        },
        ////////////////////////model/////////////////////////////////
        ...
        studentPerformance: {
          ...
          sciencePerformance: "Science Performance",
          currentEvaluation: "Current Evaluation",
          futurePrediction: "Future Prediction",
          improvementPlan: "Improvement Plan",
          standardSuggestions: "Standard Suggestions",
          advancedSuggestions: "Advanced Suggestions",
          noSubjectData: "Subject Performance Data Not Available",
          noSubjectDataMessage:
          ...
          noData: "No Performance Data Available",
          noDataMessage:
            "We couldn't find any performance data for this student. This might be because the student is new or data hasn't been collected yet.",
          score: "Score",
    ...
    ar: {
      translation: {
        ...
        motivation: {
          ...
          newWayDesc:
            "مع نظام النقاط، يصبح التعلم مليئًا بالترفيه والمتعة. لأول مرة، ستمنحك تفاعلاتك مع الأنشطة المدرسية المختلفة مكافآت وخصومات وعروضًا حصرية لأعضائنا في العديد من الأماكن والمحلات المشهورة.",
          whyTitle: "لماذا؟",
          whyDesc:
            "عندما تتفاعل مع عناصر التعلم المختلفة والأنشطة، ستحصل على نقاط وتبدأ في التنافس مع زملائك بناءً على نقاط كل واحد، تمامًا كما لو كنت تتنافس معهم في لعبة.",
          ...
          activitiesDesc:
            "عدد الأنشطة التي تتفاعل معها، على سبيل المثال عدد المناقشات التي تشارك فيها، عدد المحاضرات المرئية التي تشاهدها، عدد الواجبات التي تحلها، عدد الرسائل التي ترسلها، وهكذا.",
          weightTitle: "الوزن",
          weightDesc:
            "كل نشاط تقوم به له وزن محدد، على سبيل المثال، وزن حل واجب من 40 سؤالًا يختلف بالتأكيد عن وزن إرسال رسالة إلى معلمك وهكذا.",
          gradeTitle: "الدرجة (إن وجدت)",
          gradeDesc:
            "في الاختبارات أو الواجبات المنزلية، على سبيل المثال، ستؤثر الدرجة/العلامة التي تحصل عليها على نقاطك، لذلك إذا حصلت على العلامة الكاملة فستحصل على الحد الأقصى من النقاط لهذا الاختبار/الواجب.",
          timeTitle: "الوقت (إن وجد)",
          timeDesc:
            "كلما استجبت لأنشطتك في كلاسيرا بشكل أسرع، كلما حصلت على نقاط أكثر. على سبيل المثال، إذا حصلت على واجب منزلي تم إطلاقه يوم الاثنين ومفتوح حتى يوم الخميس، إذا قمت بتسليمه يوم الاثنين فستحصل على زيادة تصل إلى 25٪ في نقاطك، وإذا قمت بتسليمه قبل الموعد النهائي مباشرة فلن تحصل على أي مكافأة إضافية.",
          summaryTitle: "ملخص نقاطك",
          summaryDesc:
            "يبدأ كل عضو رحلته ببطاقة عضوية خضراء. في كل فصل دراسي، ستبدأ في كسب النقاط من اليوم الأول. ستحدد نقاطك النهائية في نهاية الفصل الدراسي نوع البطاقة التي تستحق استخدامها طوال الفصل الدراسي التالي كاعتراف بجهودك.",
          range1: "0 و 250",
          range2: "251 إلى 400",
          range3: "401 أو أكثر",
          cardText: " بطاقة.",
          ...
          scoreFactors:
            "تعتمد نقاطك على العديد من العوامل، فيما يلي العوامل الأربعة الرئيسية التي تؤثر على نقاطك.",
        },
        badges: {
          green: "أخضر",
          gold: "ذهبي",
        ...
        table: {
          ...
          messageComment:
            "تعتمد نقاطك على عدد المستلمين الذين يقرؤون رسالتك. المزيد من القراء = المزيد من النقاط. إذا لم يقرأها أحد، فلن تحصل على أي نقاط.",
          courseMaterials: "مواد الدورة",
        ...
        courses: {
          ...
          noSubjectsMessage:
            "يبدو أنه لا توجد مواد مخصصة لك في الوقت الحالي. يرجى التحقق لاحقًا.",
        ...
        exam: {
          ...
          alerts: {
            ...
            alreadySubmitted: {
              ...
              message:
                "لقد قمت بإرسال الامتحان بالفعل. العودة إلى قائمة الامتحانات.",
              confirmButton: "موافق",
            },
            error: {
              title: "خطأ!",
        ...
        activities: {
          ...
          hubCard: {
            ...
            noHubsMessage:
              "يبدو أنه لا توجد مراكز مدرسية متاحة حالياً. يرجى التحقق لاحقاً.",
          },
          errors: {
            title: "خطأ",
            default: "حدث خطأ ما",
        ...
        motivationteacher: {
          ...
          content05: " ",
          content11:
            "إذا كانت نقاطك تتراوح بين 251 إلى 400 في مدرستك، فسوف تكون مؤهلاً للحصول على بطاقة Learnova الذهبية.",
          content12: " ",
          content13: " ",
          content14: " ",
          content15: " ",
          content21:
            "إذا كانت نقاطك 401 أو أكثر في مدرستك، فسوف تكون مؤهلاً للحصول على بطاقة Learnova الماسية. ",
          content22: " ",
          content23: " ",
          content24: "  .",
          content25: " ",
        ...
        dashboardadmin: {
          ...
          errors: {
            network:
              "خطأ في الشبكة: فشل في جلب بعض البيانات. يرجى التحقق من اتصالك بالإنترنت.",
        ...
        teacherHeader: {
          add: "إضافة مدرس",
          searchPlaceholder:
            "ابحث عن مدرس بالاسم أو البريد الإلكتروني او النوع او الماده",
          searchPlaceholder1:
            "ابحث عن معلم صف حسب الفصل أو المادة أو المعلم أو السنة الدراسية",
        },
        parentHeader: {
          add: "إضافة ولي أمر",
          searchPlaceholder:
            " ابحث عن ولي أمر بالاسم أو البريد الإلكتروني او النوع",
        },
        managerHeader: {
          add: "إضافة مدير",
          searchPlaceholder:
            " ابحث عن مدير بالاسم أو البريد الإلكتروني او النوع",
        },
        adminHeader: {
          add: "إضافة مشرف",
          searchPlaceholder:
            " ابحث عن مشرف بالاسم أو البريد الإلكتروني او النوع",
        },
        //table
        tableHeaders: {
          name: "الاسم",
        ...
        parentTable: {
          ...
          noParentsFound: {
            ...
            description:
              "يبدو أنه لا يوجد أولياء أمور في قاعدة البيانات حالياً.",
          },
        ...
        teacherTable: {
          ...
          noTeachersFound: {
            ...
            description1:
              "يبدو أنه لا يوجد مدرسون صف  في قاعدة البيانات حالياً.",
          },
        },
        formLabels: {
          fullName: "الاسم الكامل",
        ...
        placeholders: {
          ...
          password1:
            "أدخل كلمة المرور الجديدة (اتركها فارغة للاحتفاظ بكلمة المرور الحالية)",
        ...
        validation: {
          ...
          emailValidation:
            "البريد الإلكتروني موجود بالفعل. يُرجى استخدام بريد إلكتروني آخر.",
        ...
        termList: {
          ...
          emptyState: {
            ...
            description:
              "يبدو أنه لا توجد فصول دراسية متاحة حالياً. يرجى التحقق لاحقاً أو إضافة فصول جديدة.",
          },
        },
        termForm: {
        ...
        subjectsList: {
          ...
          emptyState: {
            ...
            description:
              "يبدو أنه لا توجد مقررات دراسية متاحة حالياً. يرجى التحقق لاحقاً أو إضافة مقررات جديدة.",
          },
          subjectNames: {
        ...
        academicYear: {
          ...
          list: {
            ...
            addButton: "إضافة سنة",
            deleteConfirmation:
              "هل أنت متأكد أنك تريد حذف هذه السنة الأكاديمية؟",
            emptyState: {
              title: "لا توجد سنوات أكاديمية",
              description:
                "يبدو أنه لا توجد سنوات أكاديمية متاحة حالياً. يرجى التحقق لاحقاً أو إضافة سنوات جديدة.",
            },
          },
        },
        //schedule
        ...
        grade: {
          ...
          form: {
            ...
            messages: {
              ...
              noGradesMessage:
                "يبدو أنه لا توجد صفوف متاحة في الوقت الحالي. يرجى التحقق لاحقًا أو إضافة صفوف جديدة.",
            },
          },
          table: {
            columns: {
        ...
        parent: {
          ...
          assignments: {
            ...
            "errors": {
              "missingClassId": "معلومات الطالب مفقودة",
              "selectKidInstruction": "الرجاء اختيار طالب أولاً من قائمة أبنائك",
              "selectKidButton": "اختيار طالب"
            },
            "main": {
              "title": "الواجبات",
              ...
              "of": "من",
              "noAssignments": {
                "all": "لا توجد واجبات متاحة",
                "completed": "لا توجد واجبات مكتملة",
                "missed": "لا توجد واجبات فائتة",
                "pending": "لا توجد واجبات قيد الانتظار"
              },
              "assignmentCard": {
                "description": "الوصف",
                "createdBy": "المحاضر",
                ...
                "submitAssignment": "تسليم الواجب",
                "submission": "التسليم",
                "submittedAt": "تم تسليمه في",
              }
            },
            "sidebar": {
              "virtualRooms": "القاعات الافتراضية",
              "assignments": "الواجبات",
              "exams": "الامتحانات"
            }
          }
        ...
        gradesSemesterForChild: {
          title: "درجات الفصل الدراسي لـ",
          back: "العودة",
          subjectName: "اسم المادة",
          midtermGrade: "درجة منتصف الفصل",
          maxMidterm: "الدرجة الكاملة لمنتصف الفصل	",
          finalGrade: "درجة نهاية الفصل",
          maxFinal: "الدرجة الكاملة لنهاية الفصل",
          subjectScore: "مجموع الدرجات",
          maxSubjectScore: "المجموع الكامل",
          percentage: "النسبة المئوية",
          totalScore: "المجموع الكلي",
          degreeSubjects: "المواد الدراسية",
        ...
        chooseRole: {
          title: "جرب التعليم الرقمي كما لم يحدث من قبل",
        },
        ...
        chatbot: {
          ...
          errorMessage: "حدث خطأ. الرجاء المحاولة لاحقًا",
          unrenderableMessage: "رسالة غير قابلة للعرض",
          sender: {
            user: "أنت",
            bot: "المساعد",
          },
          inputTooltip: "الرجاء إدخال رسالة",
          buttonTooltip: "حقل الإدخال فارغ",
        },
        /////////////////////////////model//////////////////////////////
        ...
        studentPerformance: {
          ...
          sciencePerformance: "أداء مادة العلوم",
          currentEvaluation: "التقييم الحالي",
          futurePrediction: "التنبؤ المستقبلي",
          improvementPlan: "خطة التحسين",
          standardSuggestions: "اقتراحات أساسية",
          advancedSuggestions: "اقتراحات متقدمة",
          noSubjectData: "بيانات الأداء غير متوفرة للمادة",
          noSubjectDataMessage:
            "لم نتمكن من العثور على بيانات الأداء لهذه المادة. قد يكون ذلك لأن الطالب لم يكمل عددًا كافيًا من التقييمات بعد.",
          noData: "لا توجد بيانات أداء متاحة",
          noDataMessage:
            "لم نتمكن من العثور على أي بيانات أداء لهذا الطالب. قد يكون ذلك لأن الطالب جديد أو لم يتم جمع البيانات بعد.",
          score: "الدرجة",
          performance: "الأداء",
          predictedScore: "الدرجة المتوقعة",
          predictedGrade: "التقدير المتوقع",
          improvementPotential: "إمكانية التحسين",
          confidence: "الثقة",
          priority: "الأولوية",
          points: "نقاط",
          status: {
