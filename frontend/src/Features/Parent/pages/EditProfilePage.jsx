...
const ParentEditProfile = () => {
    ...
    if (fetchStatus === 'loading') {
        return <div className="text-center py-10">{t('editProfile.loading')}</div>;
    }

    if (fetchStatus === 'failed') {
        return <div className="text-center py-10 text-red-500">{fetchError || t('editProfile.loadFailed')}</div>;
    }
