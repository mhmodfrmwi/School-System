...
const Sidebar = ({ closeSidebar }) => {
  ...
  const menuItems = [
    { label: "Home", icon: Icon1, path: "/parent" },
    { label: "Motivation", icon: Icon2, path: "/parent/motivation" },
    { label: "Absence", icon: Icon4, path: "/parent/absence" },
    { label: "Schedule", icon: Icon5, path: "/parent/schedule" },
  ...
  return (
    <div className="fixed left-0 top-0 z-50 h-full w-72 transform bg-white shadow-lg transition-transform duration-300 ease-in-out">
      ...
      <div className="flex items-center p-4">
        ...
        <div className="ml-2">
          <p className="font-poppins font-semibold">Zaina Shaheen</p>
