            ...
            <div className="mx-auto w-[80%] p-6 bg-gray-100 rounded-xl shadow-md">
                <form className="space-y-4">
                    <div>
                        ...
                        <select className="h-11 w-full rounded-2xl  border-gray-300 font-poppins border p-2" name="subject" >
                    ...
                    <div>
                        ...
                        <select className="h-11 w-full rounded-2xl  border-gray-300 font-poppins border p-2" name="grade" >
