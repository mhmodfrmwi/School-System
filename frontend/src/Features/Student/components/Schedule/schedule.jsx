      ...
      englishDays.forEach((englishDay) => {
        ...
        if (session) {
          ...
          if (hours > 0 && minutes > 0) {
            durationText = `${hours} ${
              hours > 1 ? t("schedule.duration.hours") : t("schedule.duration.hour")
            } ${t("schedule.duration.and")} ${minutes} ${
              minutes > 1
                  ...
                  {timetable.slice(1).map((row, rowIndex) => (
                    ...
                    >
                      {row.map((cell, cellIndex) => (
                        <td
                          key={cellIndex}
                          className={`border-l border-gray-200 dark:border-[#E0AAEE] px-4 py-4 text-center font-poppins ${
                            cellIndex === 0
