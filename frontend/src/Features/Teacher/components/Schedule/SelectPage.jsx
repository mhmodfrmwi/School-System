        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 md:px-6 md:py-3 text-xs md:text-sm font-medium rounded-full text-center transition-all ${
            isActive("/teacher/weekly-schedule")
              ? "bg-[#008394] text-white font-bold dark:bg-DarkManager"
              : "bg-[#f4f4f4] text-[#008394] font-normal  dark:text-DarkManager"
          }`}
        >
          <span className="w-5 h-5 flex items-center justify-center border border-[#117C90] text-[#117C90] bg-white rounded-full dark:border-DarkManager dark:text-DarkManager">
            1
          </span>
