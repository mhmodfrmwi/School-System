  ...
  return (
    <>
      <div className="m-auto font-poppins mb-6 grid w-[90%] grid-cols-1 gap-2 rounded-3xl bg-gray-100 md:grid-cols-3">
        ...
        <button
          className="flex cursor-pointer items-center justify-center rounded-b-3xl bg-[#117C90] dark:bg-DarkManager py-2 font-medium text-white focus:outline-none md:rounded-3xl"
