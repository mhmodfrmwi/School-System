        ...
        >
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-gray-300 dark:border-DarkManager bg-white  px-4 py-2 text-gray-900 dark:text-DarkManager focus:outline-none focus:ring-2 focus:ring-[#117C90] dark:focus:ring-DarkManager"
